 ...
 * hardware's concrete OpenGL capabilities that are relevant to buffalo3d's
 * supported features.
 */
...
public class RenderCaps {
    ...
    static void setRenderCapsES1(GL10 $gl) /* package-private */
    {
        ...
        Log.v(Buffalo3d.TAG, "RenderCaps - openGLVersion: " + _openGlVersion);
        Log.v(Buffalo3d.TAG, "RenderCaps - maxTextureUnits: " + _maxTextureUnits);
        Log.v(Buffalo3d.TAG, "RenderCaps - maxTextureSize: " + _maxTextureSize);
        Log.v(Buffalo3d.TAG, "RenderCaps - maxLights: " + _maxLights);
    }
