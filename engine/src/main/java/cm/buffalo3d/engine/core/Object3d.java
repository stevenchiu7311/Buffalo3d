...
import cm.buffalo3d.engine.interfaces.IObject3dContainer;
import cm.buffalo3d.engine.interfaces.IObject3dParent;
import cm.buffalo3d.engine.listeners.OnClickListener;
import cm.buffalo3d.engine.listeners.OnFocusChangeListener;
import cm.buffalo3d.engine.listeners.OnLongClickListener;
import cm.buffalo3d.engine.listeners.OnTouchListener;
import cm.buffalo3d.engine.materials.AMaterial;
import cm.buffalo3d.engine.util.GLHandler;
import cm.buffalo3d.engine.vos.CameraVo;
import cm.buffalo3d.engine.vos.Color4;
import cm.buffalo3d.engine.vos.FrustumManaged;
import cm.buffalo3d.engine.vos.GLConfiguration;
import cm.buffalo3d.engine.vos.Number3d;
import cm.buffalo3d.engine.vos.Ray;
import cm.buffalo3d.engine.vos.RenderType;
import cm.buffalo3d.engine.vos.ShadeModel;
...
/*        if ((mPrivateFlags & REQUEST_TRANSPARENT_REGIONS) != 0) {
    ...
    protected Bitmap createTextureBitmap(int width, int height, Config config) {
        return null;
    }
