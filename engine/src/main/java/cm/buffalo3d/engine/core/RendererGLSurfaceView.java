...
import cm.buffalo3d.engine.interfaces.IRendererGLSurfaceViewConfig;
import cm.buffalo3d.engine.interfaces.ISceneController;
import cm.buffalo3d.engine.vos.GLConfiguration;


/**
 * Extend this class when creating your buffalo3d-based GLSurfaceView.
...
public class RendererGLSurfaceView extends RendererGLSurfaceViewProxy implements ISceneController, IRendererGLSurfaceViewConfig {
    ...
    public RendererGLSurfaceView(Context context, AttributeSet attrs) {
        ...
        cm.buffalo3d.engine.core.Renderer r = new cm.buffalo3d.engine.core.Renderer(mGContext);
