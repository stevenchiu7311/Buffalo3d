...
class MatrixGrabber {
    private final static String TAG = MatrixGrabber.class.getName();
    ...
    /**
     * Record the current modelView and projection matrix state. Has the side effect of
