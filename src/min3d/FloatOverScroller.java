 ...
 */
public class FloatOverScroller {
    private int mMode;
     ...
     * @param context
     */
    public FloatOverScroller(Context context) {
        this(context, null);
    }
     ...
     * be used.
     */
    public FloatOverScroller(Context context, Interpolator interpolator) {
     ...
     * @hide
     */
    public FloatOverScroller(Context context, Interpolator interpolator, boolean flywheel) {
